...
const { USER } = require("../EndPoints/EndPoints");
var corsOptions = {
    origin: "*",
...
mongoose.connect("mongodb+srv://ajithkumar9003221:bjePxSOGnbgDJjRi@cluster0.9pbqyr7.mongodb.net/", {
...
db.once("open", (_) => {
    console.log("Database connected:", "mongodb+srv://ajithkumar9003221:bjePxSOGnbgDJjRi@cluster0.9pbqyr7.mongodb.net/");
});
db.on("error", (err) => {
